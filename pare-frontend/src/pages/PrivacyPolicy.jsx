...
const PrivacyPolicy = () => {
  return (
    <div className="p-5 pt-24 font-metropolis md:p-10 md:pt-28 lg:px-20 2xl:px-40">
      <h1 className="text-center font-montserrat text-3xl font-bold !leading-snug md:text-4xl lg:text-5xl">
        Privacy Policy for PARE INNOVATIONS PRIVATE LIMITED
      </h1>

      <p className="my-5 md:my-8">
        At{' '}
        <Link to="/" className="cursor-pointer text-blue-500 hover:text-blue-700">
          pareindia.com
        </Link>
        , accessible from{' '}
        <Link to="/" className="cursor-pointer text-blue-500 hover:text-blue-700">
      ...
      <p className="my-5 md:my-8">
        ...
        to the information that they shared and/or collect in{' '}
        <Link to="/" className="cursor-pointer text-blue-500 hover:text-blue-700">
          pareindia.com
        </Link>
      ...
      <p className="my-5 md:my-8">We use the information we collect in various ways, including to:</p>
      ...
      <p className="my-5 md:my-8">
        ...
        follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting
        companies do this and a part of hosting services&apos; analytics. The information collected by log files include
      ...
      <p className="my-5 md:my-8">
        ...
        &apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
      ...
      <p className="my-5 md:my-8">Under the CCPA, among other rights, California consumers have the right to:</p>
      <p className="my-5 md:my-8">
      ...
      <p className="my-5 md:my-8">
        ...
        does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think
        that your child provided this kind of information on our website, we strongly encourage you to contact us
