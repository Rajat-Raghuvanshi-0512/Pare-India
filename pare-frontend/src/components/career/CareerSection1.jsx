  ...
  return (
    <section className="p-5 md:p-10 lg:p-20">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        <div className="pt-8">
          <p className="font-montserrat text-sm font-semibold">For creative Individuals</p>
          <h2 className="font-metropolis font-bold !leading-tight text-red-base lg:text-7xl">WORK FOR PARE INDIA</h2>
          ...
          <Button className={'lg:mt-6'}>apply now</Button>
        </div>
        <div>
