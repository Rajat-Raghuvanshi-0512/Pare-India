import { Blog1Avatar, Blog1BannerImg, Blog1PhoneBannerImg } from '../../assets'

const BlogInfoBanner = () => {
  return (
    <section className="md:p-10 lg:p-20 lg:pb-0 lg:pt-24">
      <div className="md:ml-20 lg:ml-40">
        <img src={Blog1BannerImg} alt="banner" className="hidden w-full md:block" />
      ...
      <img src={Blog1PhoneBannerImg} alt="banner" className="w-full md:hidden" />
    </section>
  )
}
