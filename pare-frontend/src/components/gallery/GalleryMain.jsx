import { BottomRightArrow, GalleryBanner, GalleryPhoneBanner } from '../../assets'

const GalleryMain = () => {
  return (
    <div className="relative h-screen md:px-10 md:pt-20 2xl:px-40">
      <img src={GalleryPhoneBanner} alt="gallery" className="-z-10 h-screen w-full md:hidden" />
      <img
        src={GalleryBanner}
        alt="gallery"
      ...
      <div className="absolute bottom-0 flex w-[70%] gap-5 bg-white px-5 py-2 md:gap-10 md:p-5 md:pl-20 lg:w-fit lg:pl-32">
        ...
        <div>
          <img src={BottomRightArrow} alt="arrow" className="h-[20px] w-[20px] lg:h-[40px] lg:w-[40px]" />
        </div>
      </div>
    </div>
  )
