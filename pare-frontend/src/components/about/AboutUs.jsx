    ...
    <div className="md:p-10">
      ...
      <div className="flex flex-col gap-5 md:flex-row">
        ...
        <p className="flex-1 font-montserrat text-base">
          ...
          PARÉ is strategically positioned to serve the needs of our valued customers. Our founders have deep roots in
          the building material industry, which has propelled us to become pioneers in the Innovative Products
          revolution.
        </p>
      </div>
      <div className="my-7">
      ...
      <div className="my-10 flex flex-col gap-5 font-metropolis">
        ...
        <div className="flex justify-between gap-5">
          ...
          <div className="flex-[1.2] text-right text-xs md:flex-[1.5] md:text-left md:text-lg lg:text-xl">
            PARÉ Innovations prides itself on its state-of-the-art manufacturing unit, which utilizes advanced European
            technology to manufacture products of superior quality products, PARE carries 10+ product categories
            available in 25+ shades with 3 of them being first time in the world product and systems.
          </div>
        </div>
        <div className="flex justify-between gap-5">
          <div className="flex-[0.8] text-lg font-bold uppercase text-red-base md:flex-[0.5] md:text-2xl lg:text-2xl">
          ...
          <div className="flex-[1.2] text-right text-xs md:flex-[1.5] md:text-left md:text-lg lg:text-xl">
            Our pioneering R&D team creates innovative interior solutions, pushing the boundaries of design and
            transforming spaces in India and beyond with First Time in India and First Time in The World products. The
            EASY+ Technology which is a First time in the world product is truly a marvel due to the low installation
            time, affordable cost and supremely aesthetic look.
          </div>
        </div>
      </div>
    </div>
