...
const Product1Banner = ({ data }) => {
  ...
  const { bannerPhoneImg, bannerImg, headText, mainText } = data
  return (
    <section className="relative h-[580px]">
      <Img
        src={isMobile ? bannerPhoneImg : bannerImg}
        alt={'banner'}
      ...
      <div className="absolute -bottom-3 w-full p-5 md:bottom-20 md:px-10 lg:bottom-16 lg:px-20">
        <h6 className="font-montserrat text-xl text-white lg:text-lg">{headText}</h6>
